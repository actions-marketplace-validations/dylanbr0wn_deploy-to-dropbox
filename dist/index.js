...
var DropboxAuth = /* @__PURE__ */ function() {
  function DropboxAuth2(options) {
    ...
    options = options || {};
    if (isBrowserEnv()) {
      fetch2 = window.fetch.bind(window);
      crypto = window.crypto || window.msCrypto;
    } else if (isWorkerEnv()) {
      fetch2 = self.fetch.bind(self);
      crypto = self.crypto;
    } else {
      fetch2 = (init_lib(), __toCommonJS(lib_exports));
  ...
  _createClass(DropboxAuth2, [{
    key: "setAccessToken",
    value: function setAccessToken(accessToken2) {
...
var fileWriteMode = core.getInput("FILE_WRITE_MODE");
var parsedFileWriteMode;
...
function uploadFile(filePath) {
  ...
  return __awaiter(this, void 0, void 0, function() {
    var file, destinationPath, max_retry, retry, wait, err_1, error;
    return __generator(this, function(_b) {
      switch (_b.label) {
        case 0:
          file = import_fs.default.readFileSync(filePath);
          destinationPath = "".concat(dropboxPathPrefix).concat(filePath);
          if (isDebug)
        ...
        case 2:
          _b.trys.push([2, 4, , 10]);
          return [4, dropbox.filesUpload({ path: destinationPath, contents: file, mode: parsedFileWriteMode })];
        case 3:
          return [2, _b.sent()];
        case 4:
          err_1 = _b.sent();
...
function run() {
  var e_1, _a;
  return __awaiter(this, void 0, void 0, function() {
    var files, source, globber, _b, _c, file, res, err_2, error, e_1_1;
    return __generator(this, function(_d) {
      switch (_d.label) {
        case 0:
          files = [];
          source = globSource.split(",").join("\n");
          return [4, import_glob.default.create(source)];
        case 1:
          globber = _d.sent();
          _d.label = 2;
        case 2:
