    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 10]);
                    return [4 /*yield*/, dropbox
                            .filesUpload({ path: destinationPath, contents: file, mode: parsedFileWriteMode })];
                case 3: return [2 /*return*/, _b.sent()];
                case 4:
                    err_1 = _b.sent();
                    error = err_1;
                    if (!(((_a = error === null || error === void 0 ? void 0 : error.error) === null || _a === void 0 ? void 0 : _a['.tag']) === "too_many_write_operations")) return [3 /*break*/, 8];
                    if (!(retry < max_retry)) return [3 /*break*/, 6];
                    wait = error.headers['Retry-After'];
                    console.log("Too many write operations, retrying in ", delay, " seconds");
                    return [4 /*yield*/, delay(wait * 1000)];
                case 5:
                    _b.sent();
                    retry += 1;
                    return [3 /*break*/, 7];
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, glob.create(source)];
                case 1:
                    globber = _d.sent();
                    _d.label = 2;
                case 2:
